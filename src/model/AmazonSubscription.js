...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>AmazonSubscription</code>.
  ...
  /**
   * Constructs a <code>AmazonSubscription</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AmazonSubscription} obj Optional instance to populate.
   * @return {module:model/AmazonSubscription} The populated <code>AmazonSubscription</code> instance.
   */
