...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AccessToken', 'model/AnonymizedMastering', 'model/Audio', 'model/AudioAnalysis', 'model/AudioDownloadToken', 'model/Config', 'model/ConfigAuth0', 'model/ConfigPaypal', 'model/ConfigStripe', 'model/ExternalSearchResult', 'model/ExternalSearchResultItunes', 'model/ExternalSearchResultYoutube', 'model/JWT', 'model/Kpi', 'model/LibraryAudio', 'model/LibraryAudioAnalysis', 'model/LibraryAudioLike', 'model/Mastering', 'model/Payment', 'model/PaymentCustomer', 'model/Plan', 'model/Subscription', 'model/User', 'model/Video', 'model/VideoDownloadToken', 'api/AccessTokenApi', 'api/AudioApi', 'api/ConfigApi', 'api/ExternalSearchApi', 'api/LibraryAudioApi', 'api/MasteringApi', 'api/PaymentApi', 'api/PaymentCustomerApi', 'api/PlanApi', 'api/StatisticsApi', 'api/SubscriptionApi', 'api/UserApi', 'api/VideoApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/AccessToken'), require('./model/AnonymizedMastering'), require('./model/Audio'), require('./model/AudioAnalysis'), require('./model/AudioDownloadToken'), require('./model/Config'), require('./model/ConfigAuth0'), require('./model/ConfigPaypal'), require('./model/ConfigStripe'), require('./model/ExternalSearchResult'), require('./model/ExternalSearchResultItunes'), require('./model/ExternalSearchResultYoutube'), require('./model/JWT'), require('./model/Kpi'), require('./model/LibraryAudio'), require('./model/LibraryAudioAnalysis'), require('./model/LibraryAudioLike'), require('./model/Mastering'), require('./model/Payment'), require('./model/PaymentCustomer'), require('./model/Plan'), require('./model/Subscription'), require('./model/User'), require('./model/Video'), require('./model/VideoDownloadToken'), require('./api/AccessTokenApi'), require('./api/AudioApi'), require('./api/ConfigApi'), require('./api/ExternalSearchApi'), require('./api/LibraryAudioApi'), require('./api/MasteringApi'), require('./api/PaymentApi'), require('./api/PaymentCustomerApi'), require('./api/PlanApi'), require('./api/StatisticsApi'), require('./api/SubscriptionApi'), require('./api/UserApi'), require('./api/VideoApi'));
  }
}(function(ApiClient, AccessToken, AnonymizedMastering, Audio, AudioAnalysis, AudioDownloadToken, Config, ConfigAuth0, ConfigPaypal, ConfigStripe, ExternalSearchResult, ExternalSearchResultItunes, ExternalSearchResultYoutube, JWT, Kpi, LibraryAudio, LibraryAudioAnalysis, LibraryAudioLike, Mastering, Payment, PaymentCustomer, Plan, Subscription, User, Video, VideoDownloadToken, AccessTokenApi, AudioApi, ConfigApi, ExternalSearchApi, LibraryAudioApi, MasteringApi, PaymentApi, PaymentCustomerApi, PlanApi, StatisticsApi, SubscriptionApi, UserApi, VideoApi) {
  'use strict';
