...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AnonymizedMastering', 'model/Kpi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AnonymizedMastering'), require('../model/Kpi'));
  } else {
    // Browser globals (root is window)
    if (!root.Aimastering) {
      root.Aimastering = {};
    }
    root.Aimastering.StatisticsApi = factory(root.Aimastering.ApiClient, root.Aimastering.AnonymizedMastering, root.Aimastering.Kpi);
  }
}(this, function(ApiClient, AnonymizedMastering, Kpi) {
  'use strict';
